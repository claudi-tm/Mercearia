...
public class RegistarPessoa extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        jTextField3.getText().trim().equals("") || jTextField4.getText().trim().equals("") || jTextField5.getText().trim().equals("") || jTextField6.getText().trim().equals("")){
            JOptionPane.showMessageDialog(this, "Insira todos os dados");
        } else {
            System.out.println(Integer.parseInt(jTextField2.getText()));
            Pessoa pessoa = new Pessoa(jTextField1.getText(), jTextField5.getText(), jTextField4.getText(), jTextField3.getText(), Integer.parseInt(jTextField2.getText()) , jTextField6.getText());
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistarPessoa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
