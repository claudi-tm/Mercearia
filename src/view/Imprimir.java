...
public class Imprimir extends javax.swing.JFrame {
     ...
     */
    public Imprimir() {
        Pessoa p1 = new Pessoa("Claudio Tomas", "cc", "822512163", "131414", 10, "Maputo");
        Pessoa p2 = new Pessoa("Claudio Carlos", "cA", "822512163", "131414", 30, "Tete");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        System.out.println(ligada.imprimirTodos());
    }

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ligada.bubbleSort(jComboBox1.getSelectedItem().toString(), ligada);
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            JOptionPane.showMessageDialog(this,
                    ligada.buscaImpressao(jComboBox1.getSelectedItem().toString(), jTextField1.getText()));
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
